...
export function validateFieldRowWorkexperienceInternational(dispatch, tab, index, fieldName, fieldValue) {
...
export default function TabWorkExperienceInternationally() {
    ...
    const { kinhNghiemNgoaiNuoc } = overseasStudent;
                                                    ...
                                                    <>
                                                        {fieldName === "TuThangNam" || fieldName === "DenThangNam" ? (
                                                            ...
                                                            <TextField
                                                                ...
                                                                variant="outlined"
                                                                value={fieldName === "MucLuong" ? formattedThuNhap : kinhNghiemNgoaiNuoc[editingIndex][fieldName]}
                                                                // value={kinhNghiemNgoaiNuoc[editingIndex][fieldName]}
                                                                onChange={(e) => handleFieldChange(e, fieldName, editingIndex)}
                                                                fullWidth
                                                                margin="normal"
