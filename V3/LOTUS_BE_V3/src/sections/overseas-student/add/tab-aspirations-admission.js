...
export function validateFieldAspirationsAdmission(dispatch, tab, fieldName, fieldValue) {
    const validationSchema = Yup.object().shape({
        muonVaoTruongId: Yup.string().max(4000).required("Vui lòng nhập thông tin vào trường này"),
        truongTrungTuyenId: Yup.string().max(4000).required("Vui lòng nhập thông tin vào trường này"),
        chuyenNganhHocId: Yup.string().max(4000).required("Vui lòng nhập thông tin vào trường này"),
