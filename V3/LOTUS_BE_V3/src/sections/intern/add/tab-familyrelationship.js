...
export function validateFieldRowFamilyRelationShip(dispatch, tab, index, fieldName, fieldValue) {
  const validationSchema = Yup.object().shape({
    HoTen: Yup.string().required("Vui lòng nhập thông tin vào trường này"),
    NamSinh: Yup.string()
      .required("Vui lòng nhập thông tin vào trường này")
      .matches(/^\d{4}$/, "Vui lòng nhập năm sinh đúng định dạng (4 chữ số)"),
    QuanHe: Yup.string().required("Vui lòng nhập thông tin vào trường này"),
    NgheNghiep: Yup.string().required("Vui lòng nhập thông tin vào trường này"),
    ...
    SongChung: Yup.string().required("Vui lòng nhập thông tin vào trường này"),
    ThuNhap: Yup.string().required("Vui lòng nhập thông tin vào trường này"),
  });
  ...
  const handleFieldChange = (index, e, fieldName) => {
    ...
    if (fieldValue.length >= 0) {
      ...
      if (fieldName === "ThuNhap") {
        const formattedValue = formatCurrency(fieldValue);
        console.log(formattedValue);
        setFormattedThuNhap(formattedValue);
      }
    } else {
      newValue = "";
      dispatch({
                            ...
                            <>
                              {fieldName === "NamSinh" ||
                                ...
                                <TextField
                                  ...
                                  size="small"
                                  value={
                                    fieldName === "ThuNhap" ? formattedThuNhap : row[fieldName]
                                  }
                                  onChange={(e) => handleFieldChange(index, e, fieldName)}
                                />
                              ) : (
                        ...
                        {fieldName === "QuanHe" || fieldName === "SongChung" ? (
                          ...
                          <TextField
                            ...
                            value={
                              fieldName === "ThuNhap"
                                ? formattedThuNhap
                                : quanHeGiaDinh[editingIndex][fieldName]
                            }
                            onChange={(e) => handleFieldChange(editingIndex, e, fieldName)}
                            fullWidth
                            margin="normal"
