...
export default function _INTERNTabWorkExperienceInternationally() {
  const tab = "kinhNghiemTrongNgoaiNuoc";
  const [state, dispatch] = useApp();
  const { intern } = state;
  const { kinhNghiemTrongNgoaiNuoc } = intern;
          ...
          <Grid item sm={12} md={12} xs={12}>
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {kinhNghiemTrongNgoaiNuoc.map((row, index) => (
                    <TableRow key={index}>
                  ...
                  <>
                    {selectedField === "GhiChu" ? (
                      <TextField
                        ...
                        variant="outlined"
                        value={kinhNghiemTrongNgoaiNuoc[editingIndex][selectedField]}
                      ...
                      <>
                        {fieldName === "GhiChu" ? (
                          <TextField
                            ...
                            variant="outlined"
                            value={kinhNghiemTrongNgoaiNuoc[editingIndex][fieldName]}
