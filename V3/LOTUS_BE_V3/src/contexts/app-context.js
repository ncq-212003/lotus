...
import {
  HANDLERS_CERTIFICATION,
  initialStateCertification,
  reudecerCertification
} from "./reducer/setting/reducer-certification"
...
const initialState = {
  ...
  certification: { ...initialStateCertification },
};
...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case HANDLERS_CERTIFICATION.ADD_CERTIFICATION:
    case HANDLERS_CERTIFICATION.LIST_CERTIFICATION:
    case HANDLERS_CERTIFICATION.UPDATE_CERTIFICATION:
    case HANDLERS_CERTIFICATION.FIND_CERTIFICATION:
    case HANDLERS_CERTIFICATION.DELETE_CERTIFICATION:
      return {
        ...state,
        certification: reudecerCertification(state.certification, action),
      }
    default:
