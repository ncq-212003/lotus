...
import { AddEducationLevel, ListEducationLevel } from "src/contexts/api/setting/api-educationlevel";
    ...
    const formik = useFormik({
      ...
      onSubmit: async (values, helpers) => {
          try {
              ...
              const response = await AddEducationLevel(formData)
              if (response.status === 200) {
                  ...
                  const data = await ListEducationLevel();
                  dispatch({
