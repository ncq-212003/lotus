...
import { AddProfession, ListProfession } from "src/contexts/api/setting/api-profession";
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, helpers) => {
            try {
                ...
                const response = await AddProfession(formData)
                if (response.status === 200) {
                    ...
                    const data = await ListProfession();
                    dispatch({
