...
import { addCompanyApi, listCompanyApi } from "src/contexts/api/company/api-company";
        ...
        onSubmit: async (values, helpers) => {
            try {
                const formData = {
                    ...
                    LicenseBusiness: selectedFileGiayKinhDoanh?.name.trim(),
                    Logo: selectedFileLogo?.name.trim(),
