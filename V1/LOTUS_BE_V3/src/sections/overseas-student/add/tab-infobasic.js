...
export function validateField(dispatch, tab, fieldName, fieldValue) {
    const validationSchema = Yup.object().shape({
        ...
        maHocSinh: Yup.string().required("Vui lòng nhập thông tin vào trường này"),
        ...
        dienThoai: Yup.string().required("Vui lòng nhập thông tin vào trường này").matches(/^[0-9]+$/, "Vui lòng nhập số điện thoại").max(15, "Số điện thoại tối đa là 15 số"),
        anhChanDung: Yup.string()
            .required("Vui lòng nhập thông tin vào trường này"),
        anhToanThan: Yup.string()
            .required("Vui lòng nhập thông tin vào trường này"),
