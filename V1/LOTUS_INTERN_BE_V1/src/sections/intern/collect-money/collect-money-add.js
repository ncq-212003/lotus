...
export const CollectMoneyAdd = () => {
  ...
  return (
    <Stack spacing={2} sx={{ p: 2, marginTop: "5px" }}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={7}>
          ...
          >
            ...
            >
              <Autocomplete
                onChange={(event, newValue) => formik.setFieldValue("internName", newValue)}
                value={formik.values.internName}
                name="internName"
                sx={{ margin: "4px", marginTop: "12px" }}
                fullWidth
            ...
            >
              <Autocomplete
                ...
                fullWidth
                size="small"
                options={["Phí ăn ở", "Phí đào tạo", "Bảo hiểm y tế", "Chi phí hỗ trợ tư pháp"]}
            ...
            />
            <Autocomplete
              onChange={(event, newValue) => formik.setFieldValue("paymentMethod", newValue)}
      ...
      {/* <RevenueExpenditure OpenRevenu={isDialogOpen} CloseRevenu={CloseDialog} /> */}
    </Stack>
  );
};
