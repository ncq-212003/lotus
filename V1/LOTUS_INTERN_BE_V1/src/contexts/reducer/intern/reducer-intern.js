...
const profile = [
  {
    ...
    order: "1",
    options: [
      { value: 1, label: "Có người thân bên nhật" },
      { value: 2, label: "Không có người thân bên nhật" },
    ],
    answer: "",
    position: "TTS",
  },
...
const reducerIntern = (state, action) =>
  handlersBeforeIntern[action.type] ? handlersBeforeIntern[action.type](state, action) : state;
