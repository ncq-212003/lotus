...
const handlersDepartment = {
    ...
    // list
    [HANDLERS_DEPARMENT.LIST_DEPARMENT]: (state, action) => {
    ...
    // update
    [HANDLERS_DEPARMENT.UPDATE_DEPARMENT]: (state, action) => {
        return state;
    },
};
