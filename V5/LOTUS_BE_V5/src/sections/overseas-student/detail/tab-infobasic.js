                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <span style={{ fontWeight: 'bold' }}>Mã du học sinh:</span> {iStudentCode}
                            </Typography>
                            <Typography
                                variant="body1"
                                sx={{
                            ...
                            >
                                <span style={{ fontWeight: 'bold' }}>Ngày nhập học:</span> {formatDate(dateEntrance)}
                            </Typography>
                        ...
                        >
                            ...
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Nơi cấp hộ chiếu:</span> {passportProvideLocation}
                            </Typography>
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Ngày cấp:</span>  {formatDate(passportProvideDate)}
                            </Typography>
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Ngày hết hạn:</span> {formatDate(passportExpiredDate)}
                            </Typography>
                        </Box>
                        <Box
                            sx={{
                        ...
                        >
                            ...
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Ngày hết hạn:</span> {formatDate(visaExpiredDate)}
                            </Typography>
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                    ...
                    >
                        ...
                        >
                            ...
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Muốn đi:</span> {JSON.parse(listWishMarketId)
                                    .map((wtg) => wtg.wishMarket)
                                    .join(", ")}
                            </Typography>
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Cán bộ tuyển dụng:</span> {employeeRecruitmentName}
                            </Typography>
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Kinh nghiệm:</span> {JSON.parse(listPassExperience)
                                    .map((exp) => exp.job)
                                    .join(", ")}
                            </Typography>
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Nhóm nguồn cung ứng:</span> {supplySource.find((supply) => supply.value === supplySourceId)?.label}
                            </Typography>
                        </Box>
                    </Grid>
                </Grid>
