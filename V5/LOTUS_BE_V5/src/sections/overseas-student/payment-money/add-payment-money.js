...
//OvsProfile
const ovsProfiles = [
  { id: "PRDHS000001", name: "Nguyễn Văn A" },
  { id: "PRDHS000002", name: "Nguyễn Văn B" },
  { id: "PRDHS000003", name: "Nguyễn Văn C" },
];
...
export const PaymentMoney = () => {
  const [showOvsName, setShowOvsName] = useState(false);
  ...
  const validationSchema = Yup.object({
    ...
    ovsName: Yup.string().required("Vui lòng nhập thông tin vào trường này"),
  ...
  useEffect(() => {
    const selectedProfile = ovsProfiles.find((profile) => profile.id === formik.values.profileCode);

    if (selectedProfile) {
      formik.setFieldValue("ovsName", selectedProfile.name);
      setShowOvsName(true);
    } else {
      formik.setFieldValue("ovsName", "");
      setShowOvsName(false);
    }
  }, [formik.values.profileCode, ovsProfiles]);
        ...
        <Grid item xs={7}>
          ...
          >
            ...
            <Autocomplete
              ...
              value={ovsProfiles.find((u) => u.id === formik.values.profileCode) || null}
            ...
            {showOvsName && (
              <TextField
                error={!!(formik.touched.ovsName && formik.errors.ovsName)}
                helperText={formik.touched.ovsName && formik.errors.ovsName}
                onBlur={formik.handleBlur}
                onChange={formik.handleChange}
