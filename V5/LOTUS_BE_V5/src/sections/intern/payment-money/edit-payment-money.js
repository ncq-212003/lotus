...
const initialValues = {
  ...
  accountPayment: rowData?.accountPayment || "",
  money: rowData?.money || "",
  internName: rowData?.internName || "",
            ...
            <Grid container spacing={2}>
                ...
                >
                  ...
                  >
                    <Autocomplete
                      ...
                      onChange={(e, value) =>
                        formik.setFieldValue("collectCategories", value?.id || "")
                      }
                      ...
                      renderInput={(params) => (
                        <TextField
                          error={
                            !!(formik.touched.collectCategories && formik.errors.collectCategories)
                          }
                          helperText={
                            formik.touched.collectCategories && formik.errors.collectCategories
                          }
                  ...
                  {showAccountField && (
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField {...params} label="Tài khoản/Quỹ" variant="outlined" />
                      )}
                    />
                  )}
                  <DateTimePicker
              ...
              <Grid item xs={5}>
                ...
                >
                  ...
                  <TextField
                    error={
                      !!(formik.touched.accompanyingDocument && formik.errors.accompanyingDocument)
                    }
                    helperText={
                      formik.touched.accompanyingDocument && formik.errors.accompanyingDocument
                    }
