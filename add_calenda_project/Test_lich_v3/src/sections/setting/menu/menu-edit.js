        ...
        onSubmit: async (values, helpers) => {
            try {
                const formData = {
                    ...
                    SParentIdHidden: values.parentId,
                    CreatedByHidden: "1",
                    SMenuIcon: values.menuIcon,
                    SMenuLink: values.menuLink,
                    Flag: "1",
                    SMenuId: id,
                    LastModifiedAt: new Date().toISOString(),
                    LastModifiedBy: "1",
                    TimeStamp: Math.floor(new Date().getTime() / 1000),
                    Field1: values.menuOrder,
                    SParentId: values.parentId,
                    Field2: "1",
                    Field3: "1",
                    Field4: "1",
