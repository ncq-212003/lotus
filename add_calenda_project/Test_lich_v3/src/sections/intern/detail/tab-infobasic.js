        ...
        <Grid container spacing={2}>
          <Grid item sm={12} md={6} xs={12}>
            ...
            >
              ...
              >
                <span style={{ fontWeight: "bold" }}>Mã thực tập sinh:</span> ABC000001
              </Typography>
              <Typography
                variant="body1"
                sx={{
          ...
          <Grid item sm={12} md={6} xs={12}>
            ...
            >
              ...
              <Typography variant="body1" sx={{ marginBottom: "16px" }}>
                <span style={{ fontWeight: "bold" }}>Số nhà, đường phố/Thôn:</span> 123 Đường ABC,
                Thôn XYZ
              </Typography>
              <Typography variant="body1" sx={{ marginBottom: "16px" }}>
            ...
            >
              ...
              <Typography variant="body1" sx={{ marginBottom: "12px" }}>
                <span style={{ fontWeight: "bold" }}>Nhóm nguồn cung ứng:</span> Cá nhân
              </Typography>
              <Typography variant="body1" sx={{ marginBottom: "16px" }}>
                <span style={{ fontWeight: "bold" }}>Ghi chú:</span> note
              </Typography>
