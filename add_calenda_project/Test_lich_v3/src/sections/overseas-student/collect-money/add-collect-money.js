...
import RevenueAdd from "src/sections/finance/revenue-expenditure/form-revenue-expenditure";
...
export const CollectMoney = () => {
  ...
  const validationSchema = Yup.object({
    ...
    overseasName: Yup
      .string()
      .required('Du học sinh không được để trống'),
    company: Yup
      .string()
  ...
  return (
    <Stack spacing={2} sx={{ p: 2, marginTop: "5px" }}>
      ...
      {/* <RevenueAdd OpenRevenu={isDialogOpen} CloseRevenu={CloseDialog} /> */}
    </Stack>
  );
};
