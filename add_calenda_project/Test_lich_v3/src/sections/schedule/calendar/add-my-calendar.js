...
export const AddCalendar = (props) => {
  ...
  const [companyOptions, setCompanyOptions] = useState(
    [
      { id: 1, label: "Công ty Mitsubishi Group" },
      { id: 2, label: "Công ty Sumitomo Group" },
      { id: 3, label: "Công ty Sharp Corporation" },
      { id: 4, label: "Công ty Panasonic Corporation" },
    ]
  )
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <Grid container>
            ...
            {/* 
            <Autocomplete
              onChange={(event, newValue) => formik.setFieldValue("congTyTiepNhan", newValue || "")}
              value={formik.values.congTyTiepNhan}
              name="congTyTiepNhan"
              sx={{ margin: "12px 4px 0px 4px " }}
              fullWidth
              size="small"
              ...
              renderInput={(params) => <TextField
                ...
                {...params} label="Công ty tiếp nhận" variant="outlined" />}
            /> */}
            ...
            <Autocomplete
              ...
              size="small"
              options={companyOptions}
              value={companyOptions.find(option => option.id === formik.values.congTyTiepNhan) || null}
              onChange={(event, value) => handleAutocompleteChangeId('congTyTiepNhan', value)}
              onBlur={formik.handleBlur('congTyTiepNhan')}
              renderInput={(params) => (
                <TextField
                  variant="outlined"
                  {...params}
      ...
      <AddCustomer openCustomer={IsCustomer} closeCustomer={closeCustomer} typeUnionNumber={typeUnionNumber} />
