...
import { AddCalendar } from "src/sections/schedule/calendar/add-calendar";
import { TabbleEveryoneCalendar } from "src/sections/schedule/calendar/everyone-table-calendar";
    ...
    <>
      ...
      >
        <Container maxWidth="xl">
          ...
          {/* {IsCalendar ? <AddCalendar closeAdd={closeHandleCalendar} /> : <CalendarTable />} */}
          <EveryoneCalendar />
          <TabbleEveryoneCalendar />
        </Container>
      </Box>
    </>
  );
