                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <Autocomplete
                                error={!!(formik.touched.quocGia && formik.errors.quocGia)}
                                helperText={formik.touched.quocGia && formik.errors.quocGia}
                                onBlur={formik.handleBlur}
                                onChange={(event, newValue) => formik.setFieldValue("quocGia", newValue)}
                                ...
                                renderInput={(params) => <TextField {...params} label="Quốc gia" variant="outlined" />}
                            />
                            <Box
                                sx={{
                                    display: 'flex',
