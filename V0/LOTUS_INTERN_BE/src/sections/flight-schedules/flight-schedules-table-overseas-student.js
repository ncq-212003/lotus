...
import flightChedulesAdd from "./flight-schedules-add";
...
export default function FlightSChedulesTable() {
  ...
  const columns = [
    ...
    {
      field: "intern",
      headerName: "Tên thực tập sinh",
      width: 150,
    },
    {
      field: "expectedFlight",
      headerName: "Ngày giờ bay dự kiến",
      width: 160,
    },
    {
      field: "expectedArrival",
      headerName: "Ngày giờ đến dự kiến",
      width: 160,
    },
    {
      field: "personInCharge",
      headerName: "Người phụ tránh chính",
      width: 150,
    },
    {
      field: "ariportGoFrom",
          ...
          <Tooltip title="Lịch sử bay">
            <IconButton sx={{ color: "black" }}>
              <GridActionsCellItem
                icon={<HistoryIcon />}
                label="ViewHistory"
                onClick={handleViewHistorySupplyClick(params.id)}
                color="inherit"
              />
            </IconButton>
          </Tooltip>
        ...
        <Stack spacing={3} sx={{ p: 2, width: "600px" }}>
          <TableContainer sx={{ border: "1px solid #ccc", borderRadius: "4px", maxHeight: 400 }}>
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell>Ngày giớ bay dự kiến</TableCell>
                  <TableCell>Ngày giờ đến dự kiến</TableCell>
