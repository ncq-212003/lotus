                ...
                >
                        ...
                        >
                            ...
                            >
                                <Typography
                                    variant="body1"
                                >
                                    <span style={{ fontWeight: 'bold' }}>Mã hồ sơ:</span> ABC123
                                </Typography>
                                <Typography
                                    variant="body1"
                                >
                                    <span style={{ fontWeight: 'bold' }}>Ngày đăng ký:</span> 01/01/2023
                                </Typography>
                            </Box>
                    ...
                    >
                        ...
                        >
                            ...
                            <Typography variant="body1"
                                sx={{ marginBottom: '16px' }}>
                                <span style={{ fontWeight: 'bold' }}>Điện thoại cố định:</span> 0123456789
                            </Typography>
                            <Box
                                sx={{
                                    margin: '20px 0px',
                        ...
                        >
                            ...
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Muốn đi:</span> Nhật
                            </Typography>
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                            ...
                            <Typography variant="body1"
                                sx={{ marginBottom: '12px' }}>
                                <span style={{ fontWeight: 'bold' }}>Nhóm nguồn:</span> Nguồn dài hạn
                            </Typography>
                        </Box>
                    </Grid>
                </Grid>
