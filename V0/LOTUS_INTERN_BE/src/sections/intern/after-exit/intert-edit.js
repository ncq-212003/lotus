...
export default function InternEdit({ open, onClose }) {
  ...
  return (
    ...
    >
      ...
      {/* <TabContext value={valueTabTwo}>
        <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
          <TabList onChange={handleChangeTwo}>
            <Tab label="Quan hệ gia đình" value={1} />
            <Tab label="Quá trình học tập" value={2} />
            <Tab label="Kinh nghiệm làm việc trong nước" value={3} />
            <Tab label="Kinh nghiệm làm việc ngoài nước" value={4} />
          </TabList>
        </Box>
        <TabPanel
          value={1}
